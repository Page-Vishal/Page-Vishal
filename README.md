...
&nbsp;&nbsp;&nbsp;&nbsp;[SQL-Mind](https://sqlmind.streamlit.app/) : Chat with your postgres database. (Example using [render](https://render.com/) postgres) [The database details have wrong password as why not?] </br>
